...
export const AgencyPasswordResetEmail: EmailTemplate<PasswordResetEmailData> = {
  name: 'agency-password-reset',
  subject: 'Reset your CENIE AGENCY password',
  component: ({ userName, resetUrl, expiresIn, branding, typography, baseUrl }) => (
    <BaseLayout branding={branding} typography={typography} preview="Reset your password">
      ...
      <Text style={{ fontFamily: typography.bodyFont, lineHeight: '1.6', marginBottom: '24px' }}>
        We received a request to reset your password for your CENIE AGENCY account. Click the
