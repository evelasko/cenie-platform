...
interface BoldNavbarMobileRootProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string
}

const BoldNavbarMobileRoot = React.forwardRef<HTMLDivElement, BoldNavbarMobileRootProps>(
  function BoldNavbarMobileRoot({ className, ...otherProps }: BoldNavbarMobileRootProps, ref) {
    return (
      <div
        className={SubframeUtils.twClassNames(
        ...
        <div className="flex items-center gap-2 px-2">
          ...
          <SubframeCore.Popover.Root>
            ...
            <SubframeCore.Popover.Portal>
              <SubframeCore.Popover.Content side="bottom" align="end" sideOffset={4} asChild={true}>
