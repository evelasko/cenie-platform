...
interface AccordionFaqRootProps extends React.ComponentProps<typeof SubframeCore.Collapsible.Root> {
  trigger?: React.ReactNode
  children?: React.ReactNode
  className?: string
}

const AccordionFaqRoot = React.forwardRef<HTMLDivElement, AccordionFaqRootProps>(
