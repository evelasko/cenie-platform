  ...
  return (
    <button
      className={SubframeUtils.twClassNames(
        ...
        {
          'h-9 w-auto flex-row flex-nowrap gap-1 rounded-full px-4 py-0': size === 'small',
          'h-16 w-auto flex-row flex-nowrap gap-4 rounded-full px-12 py-0': size === 'large',
    ...
    >
      ...
      {children ? (
        <span
          className={SubframeUtils.twClassNames(
            'whitespace-nowrap text-button-medium font-button-medium text-black group-disabled/3b777358:text-neutral-400',
            {
              hidden: loading,
              'text-body font-body': size === 'small',
