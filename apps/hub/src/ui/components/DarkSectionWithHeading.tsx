...
interface DarkSectionWithHeadingRootProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-start gap-2">
        ...
        <div
          className={SubframeUtils.twClassNames('flex w-full items-start gap-2 py-12', {
            hidden: variant === 'empty',
          })}
        >
          <IconWithBackground variant="light" size="x-small" icon={icon} square={false} />
          {overlineText ? (
