...
interface QuarterColumnLayoutRootProps extends React.HTMLAttributes<HTMLDivElement> {
  padded?: 'default' | 'large'
  mobile?: boolean
  className?: string
}

const QuarterColumnLayoutRoot = React.forwardRef<HTMLDivElement, QuarterColumnLayoutRootProps>(
  function QuarterColumnLayoutRoot(
    { padded = 'default', mobile = false, className, ...otherProps }: QuarterColumnLayoutRootProps,
    ref
  ) {
    return (
      <div
        ...
        >
          ...
          >
            <span className="w-full text-body font-body text-default-font">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean non blandit libero.
              Duis blandit condimentum urna vel consequat. Nulla rhoncus dapibus imperdiet. Nullam
              sit amet orci vel justo porttitor accumsan eu quis risus. Phasellus mollis scelerisque
              varius. Pellentesque sed augue egestas, feugiat purus id, feugiat eros. Morbi gravida
              mi id velit venenatis congue.
            </span>
          </div>
