...
export default function PublicationsPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      {/* Hero Section */}
      <div className="mb-12">
        <h1 className="text-display-text-extra-large mb-6">Featured Research: Ideas Shaping the Future of Performance</h1>
      ...
      <section className="mb-16">
        <p className="text-body mb-6">
          This is your curated briefing on the most important scholarship emerging from the CENIE ecosystem. We hand-select publications from our official academic press, <strong>CENIE Editorial</strong>, and provide concise summaries to explain not just <em>what</em> the research says, but <em>why it matters</em> to you as an artist, an educator, a producer, or a fellow scholar.
        </p>
        <p className="text-body">
          The full, peer-reviewed articles and books are hosted on their permanent home at <strong>CENIE Editorial</strong>, our dedicated publishing platform. Think of this page as your gateway to the most impactful ideas in our field.
        </p>
      </section>
          ...
          <div className="bg-card p-8 rounded-lg">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-2">
                ...
                <h3 className="text-display-text-medium mb-3">The Algorithmic Muse: A Framework for Human-AI Choreographic Collaboration</h3>
          ...
          <div className="bg-card p-8 rounded-lg">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-2">
                ...
                <h3 className="text-display-text-medium mb-3">The Portfolio Career: A New Economic Model for Performing Artists in the Digital Age</h3>
              ...
              <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 rounded-lg p-6 flex items-center justify-center">
                <div className="text-center">
          ...
          <div className="bg-card p-8 rounded-lg">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-2">
                ...
                <h3 className="text-display-text-medium mb-3">Somatic Feedback Loops: Reducing Injury in Elite Dancers Through Real-Time Data</h3>
              ...
              <div className="bg-gradient-to-br from-accent/10 to-accent/5 rounded-lg p-6 flex items-center justify-center">
                <div className="text-center">
      ...
      <section className="mb-16 bg-muted p-8 rounded-lg">
        ...
        <Link href="/insights/publish-with-us" className="inline-block bg-primary text-white px-8 py-3 rounded-md hover:bg-primary/90 text-button-large">
      ...
      <section className="bg-primary/5 p-12 rounded-lg">
        <h2 className="text-display-text-large mb-8 text-center">Stay at the Forefront of the Conversation</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg">
            ...
            <Link href="/connect" className="inline-block w-full text-center bg-secondary text-secondary-foreground px-6 py-3 rounded-md hover:bg-secondary/90 text-button-medium">
