        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-3xl font-bold text-gray-900">CENIE Dashboard</h1>
            </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{user.providerId}</dd>
                </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="prose">
                ...
                <p className="text-gray-600">
                  You can now integrate this authentication system with your auth-api service to
                  manage user profiles, app access, and other user-related data.
                </p>
              </div>
            </div>
          </div>
