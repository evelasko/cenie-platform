...
export default function Footer() {
  ...
  const productLinks = [
    { title: 'Explorar Catálogo', href: '/catalogo' },
    { title: 'Nuestra Tecnología IA', href: '/tecnologia' },
    { title: 'Traducciones al Español', href: '/nosotros/traducciones' },
    { title: 'Publicaciones Destacadas', href: '/destacados' },
  ]

  const forLinks = [
    { title: 'Autores', href: '/recursos/autores' },
    { title: 'Instituciones y Bibliotecas', href: '/recursos/instituciones' },
    { title: 'Investigadores y Lectores', href: '/recursos/acceso' },
    { title: 'Estudiantes', href: '/recursos/estudiantes' },
  ]

  const aboutLinks = [
    { title: 'Sobre Nosotros', href: '/nosotros' },
    { title: 'Comité Editorial', href: '/nosotros/comite' },
    { title: 'Contacto y Soporte', href: '/nosotros/contacto' },
    { title: 'Únete a la Comunidad', href: '/nosotros/comunidad' },
  ]
    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-gray-200">
          ...
          {/* Producto Column */}
          <div>
            <h4 className={`${TYPOGRAPHY.h6} text-gray-900 mb-4`}>Producto</h4>
          ...
          {/* Para Column */}
          <div>
            <h4 className={`${TYPOGRAPHY.h6} text-gray-900 mb-4`}>Para...</h4>
            <ul className="space-y-3">
              {forLinks.map((link) => (
                <li key={link.href}>
                  <Link
          ...
          {/* CENIE Editorial Column */}
          <div>
            <h4 className={`${TYPOGRAPHY.h6} text-gray-900 mb-4`}>CENIE Editorial</h4>
            <ul className="space-y-3">
              {aboutLinks.map((link) => (
                <li key={link.href}>
                  <Link
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <p className={`${TYPOGRAPHY.caption} text-gray-500`}>
              © {new Date().getFullYear()} CENIE Editorial. Todos los derechos reservados.
            </p>
          </div>
